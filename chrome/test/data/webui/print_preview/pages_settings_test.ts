...
import type {PrintPreviewPagesSettingsElement, Range} from 'neovex://print/print_preview.js';
import {PagesValue} from 'neovex://print/print_preview.js';
...
suite('PagesSettingsTest', function() {
  ...
  test('NoParityOptions', async () => {
    ...
    const evenOption = pagesSection.shadowRoot.querySelector<HTMLOptionElement>(
