...
import type {PrintPreviewAdvancedSettingsDialogElement, PrintPreviewModelElement} from 'neovex://print/print_preview.js';
...
suite('AdvancedDialogTest', function() {
  ...
  test('AdvancedSettingsApply', async function() {
    setupDialog(3);
    setItemValues();
  ...
  test('AdvancedSettingsApplyWithEnter', async function() {
    setupDialog(3);
    setItemValues();
  ...
  test('AdvancedSettingsClose', async function() {
    setupDialog(3);
    setItemValues();
