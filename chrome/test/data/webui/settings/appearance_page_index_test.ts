...
import type {SettingsAppearancePageIndexElement} from 'neovex://settings/settings.js';
import {AppearanceBrowserProxyImpl, CrSettingsPrefs, Router, routes} from 'neovex://settings/settings.js';
