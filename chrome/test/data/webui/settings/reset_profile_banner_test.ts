...
import type {SettingsResetProfileBannerElement} from 'neovex://settings/settings.js';
import {loadTimeData, ResetBrowserProxyImpl, Router, routes} from 'neovex://settings/settings.js';
