...
// clang-format off
import type {GeolocationPageElement} from 'neovex://settings/lazy_load.js';
import {ContentSetting, ContentSettingsTypes, SiteSettingsBrowserProxyImpl, SettingsState} from 'neovex://settings/lazy_load.js';
