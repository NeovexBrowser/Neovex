...
import type {CrCollapseElement, SecureDnsInputElement, SettingsSecureDnsElement, SettingsToggleButtonElement} from 'neovex://settings/lazy_load.js';
import {SecureDnsResolverType} from 'neovex://settings/lazy_load.js';
import type {ResolverOption} from 'neovex://settings/settings.js';
import {loadTimeData, PrivacyPageBrowserProxyImpl, SecureDnsMode, SecureDnsUiManagementMode} from 'neovex://settings/settings.js';
