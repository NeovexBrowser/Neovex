...
import type {FontsBrowserProxy, FontsData,SettingsAppearanceFontsPageElement} from 'neovex://settings/lazy_load.js';
import {FontsBrowserProxyImpl} from 'neovex://settings/lazy_load.js';
