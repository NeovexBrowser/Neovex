...
import type {SettingsPerformancePageIndexElement} from 'neovex://settings/settings.js';
import {CrSettingsPrefs, PerformanceBrowserProxyImpl, Router, routes} from 'neovex://settings/settings.js';
