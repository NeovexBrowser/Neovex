...
import type {ExtensionControlledIndicatorElement} from 'neovex://settings/settings.js';
import {OpenWindowProxyImpl, ExtensionControlBrowserProxyImpl} from 'neovex://settings/settings.js';
