...
import type {LensUploadDialogElement} from 'neovex://new-tab-page/lazy_load.js';
import {LensErrorType, LensSubmitType, LensUploadDialogAction, LensUploadDialogError} from 'neovex://new-tab-page/lazy_load.js';
