...
import 'neovex://history-sync-optin/history_sync_optin_app.js';
...
import type {HistorySyncOptinAppElement} from 'neovex://history-sync-optin/history_sync_optin_app.js';
...
suite('HistorySyncOptinAppTest', function() {
  let app: HistorySyncOptinAppElement;
  ...
  setup(async function() {
    ...
    app = document.createElement('history-sync-optin-app');
