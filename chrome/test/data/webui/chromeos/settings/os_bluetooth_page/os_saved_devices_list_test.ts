...
import type {SettingsSavedDevicesListElement} from 'neovex://os-settings/lazy_load.js';
import {OsBluetoothDevicesSubpageBrowserProxyImpl} from 'neovex://os-settings/os_settings.js';
