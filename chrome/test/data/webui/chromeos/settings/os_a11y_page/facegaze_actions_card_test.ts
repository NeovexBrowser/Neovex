...
import type {FaceGazeAddActionDialogElement, KeyCombination} from 'neovex://os-settings/lazy_load.js';
import {AddDialogPage, AssignedKeyCombo, FACEGAZE_COMMAND_PAIR_ADDED_EVENT_NAME, FaceGazeActionsCardElement, FaceGazeCommandPair} from 'neovex://os-settings/lazy_load.js';
import type {CrButtonElement, CrIconButtonElement, SettingsPrefsElement, SettingsToggleButtonElement} from 'neovex://os-settings/os_settings.js';
