...
import type {CrButtonElement, CrLinkRowElement, ParentalControlsSettingsCardElement} from 'neovex://os-settings/os_settings.js';
import {ParentalControlsBrowserProxyImpl, Router, routes, settingMojom} from 'neovex://os-settings/os_settings.js';
