...
import type {SettingsInternetKnownNetworksPageElement} from 'neovex://os-settings/lazy_load.js';
import type {CrActionMenuElement, CrIconButtonElement} from 'neovex://os-settings/os_settings.js';
