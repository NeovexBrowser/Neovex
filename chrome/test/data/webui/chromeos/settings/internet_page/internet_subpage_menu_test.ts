...
import type {SettingsInternetSubpageMenuElement} from 'neovex://os-settings/lazy_load.js';
import type {CrActionMenuElement} from 'neovex://os-settings/os_settings.js';
