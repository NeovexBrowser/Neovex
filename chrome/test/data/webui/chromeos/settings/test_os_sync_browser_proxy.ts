...
import type {ChromeSigninAccessPoint, ChromeSigninUserChoiceInfo, StoredAccount, SyncBrowserProxy, SyncPrefs, SyncStatus} from 'neovex://os-settings/os_settings.js';
import {ChromeSigninUserChoice, PageStatus, SignedInState, StatusAction} from 'neovex://os-settings/os_settings.js';
