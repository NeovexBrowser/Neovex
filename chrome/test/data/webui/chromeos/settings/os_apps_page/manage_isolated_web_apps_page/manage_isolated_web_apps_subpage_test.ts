...
import type {ManageIsolatedWebAppsSubpageElement} from 'neovex://os-settings/lazy_load.js';
import {CrSettingsPrefs, type SettingsPrefsElement} from 'neovex://os-settings/os_settings.js';
