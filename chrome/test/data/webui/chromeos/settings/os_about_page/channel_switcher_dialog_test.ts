...
import type {SettingsChannelSwitcherDialogElement} from 'neovex://os-settings/lazy_load.js';
import {AboutPageBrowserProxyImpl, BrowserChannel} from 'neovex://os-settings/os_settings.js';
