...
import type {SettingsCustomizeMouseButtonsSubpageElement} from 'neovex://os-settings/lazy_load.js';
import type {CrToggleElement, FakeInputDeviceSettingsProvider, Mouse} from 'neovex://os-settings/os_settings.js';
import {fakeMice, fakeMouseButtonActions, getInputDeviceSettingsProvider, PolicyStatus, Router, routes, setupFakeInputDeviceSettingsProvider} from 'neovex://os-settings/os_settings.js';
