...
import type {SettingsKeyboardElement} from 'neovex://os-settings/lazy_load.js';
import type {CrLinkRowElement, Route, SettingsSliderElement} from 'neovex://os-settings/os_settings.js';
