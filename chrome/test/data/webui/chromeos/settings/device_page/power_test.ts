...
import type {SettingsPowerElement} from 'neovex://os-settings/lazy_load.js';
import type {BatteryStatus, CrButtonElement, CrDialogElement, CrPolicyIndicatorElement, CrRadioButtonElement, PowerSource, SettingsToggleButtonElement, SettingsToggleV2Element} from 'neovex://os-settings/os_settings.js';
import {DevicePageBrowserProxyImpl, IdleBehavior, LidClosedBehavior, OptimizedChargingStrategy, Router, routes, settingMojom} from 'neovex://os-settings/os_settings.js';
