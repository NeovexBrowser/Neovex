...
import type {CupsPrinterInfo, CupsPrintersBrowserProxy, CupsPrintersList, ManufacturersInfo, ModelsInfo, PrinterMakeModel, PrinterPpdMakeModel, PrinterStatus, PrinterStatusReason, PrinterStatusSeverity} from 'neovex://os-settings/lazy_load.js';
import {PrinterSetupResult, PrintServerResult} from 'neovex://os-settings/lazy_load.js';
