...
import type {PrinterListEntry, SettingsCupsPrintersEntryElement} from 'neovex://os-settings/lazy_load.js';
import {PrinterSettingsUserAction, PrinterStatusReason, PrinterType} from 'neovex://os-settings/lazy_load.js';
