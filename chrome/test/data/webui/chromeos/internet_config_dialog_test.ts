...
import 'neovex://internet-config-dialog/internet_config_dialog.js';

import type {InternetConfigDialogElement} from 'neovex://internet-config-dialog/internet_config_dialog.js';
