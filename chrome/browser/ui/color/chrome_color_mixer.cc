...
void AddChromeColorMixer(ui::ColorProvider* provider,
  ...
  // === CUSTOM THEME: NTP-matched hover card colors ===
  mixer[kColorTabHoverCardBackground] = {SkColorSetRGB(0x16, 0x16, 0x2a)};
  mixer[kColorTabHoverCardForeground] = {SkColorSetRGB(0x2a, 0x2a, 0x44)};
  mixer[kColorTabHoverCardSecondaryText] = {SkColorSetRGB(0xe0, 0xe0, 0xff)};
  ...
  // === CUSTOM THEME: NTP-matched toolbar color ===
  ...
  // === CUSTOM THEME: NTP-matched toolbar icon colors ===
  mixer[kColorToolbarButtonIcon] = {SkColorSetRGB(0x95, 0x95, 0xb8)};
  mixer[kColorToolbarButtonIconDefault] = {SkColorSetRGB(0x95, 0x95, 0xb8)};
  ...
  // === CUSTOM THEME: NTP-matched separator ===
  mixer[kColorToolbarContentAreaSeparator] = {SkColorSetRGB(0x2a, 0x2a, 0x44)};
  ...
  // === CUSTOM THEME: NTP-matched toolbar text color ===
  mixer[kColorToolbarText] = {SkColorSetRGB(0xe0, 0xe0, 0xff)};
  mixer[kColorToolbarTextDefault] = {SkColorSetRGB(0xe0, 0xe0, 0xff)};
