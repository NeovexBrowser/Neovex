...
import 'neovex://resources/ash/common/network/network_proxy.js';
...
import 'neovex://resources/ash/common/cr_elements/policy/cr_policy_indicator_mixin.js';
import '/strings.m.js';
...
import {getApnDisplayName, isActiveSim} from 'neovex://resources/ash/common/network/cellular_utils.js';
...
import type {ApnProperties, ConfigProperties, CrosNetworkConfigInterface, GlobalPolicy, IPConfigProperties, ManagedProperties, ProxySettings} from 'neovex://resources/mojo/chromeos/services/network_config/public/mojom/cros_network_config.mojom-webui.js';
import {MAX_NUM_CUSTOM_APNS, StartConnectResult} from 'neovex://resources/mojo/chromeos/services/network_config/public/mojom/cros_network_config.mojom-webui.js';
import {ConnectionStateType, NetworkType, OncSource, PortalState} from 'neovex://resources/mojo/chromeos/services/network_config/public/mojom/network_types.mojom-webui.js';
