...
interface ConfirmPasswordChangeElement {
  $: {
...
class ConfirmPasswordChangeElement extends ConfirmPasswordChangeElementBase {
  ...
  private onIncorrectOldPassword_() {
  ...
  private findFirstError_(): ValidationErrorType {
    if (this.showOldPasswordPrompt_) {
  ...
  private invalidOldPassword_(): boolean {
  ...
  private getErrorString_(): string {
