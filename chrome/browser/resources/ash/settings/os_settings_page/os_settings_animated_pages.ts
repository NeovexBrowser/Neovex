...
import type {IronPagesElement} from 'neovex://resources/polymer/v3_0/iron-pages/iron-pages.js';
import {DomIf, FlattenedNodesObserver, microTask, PolymerElement} from 'neovex://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
...
class OsSettingsAnimatedPagesElement extends
  ...
  override currentRouteChanged(newRoute: Route, oldRoute?: Route): void {
    ...
    // Given only one section shows at a time, avoid unnecessarily
    // changing the active page for this section if the active route belongs
    // to a different section.
    if (newRoute.section !== null && newRoute.section !== this.section) {
      return;
    }
