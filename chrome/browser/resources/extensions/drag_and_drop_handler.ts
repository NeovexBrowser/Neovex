...
import type {DragWrapperDelegate} from 'neovex://resources/js/drag_wrapper.js';
...
export class DragAndDropHandler implements DragWrapperDelegate {
  ...
  doDrop(e: DragEvent) {
    ...
    // `DataTransferItem.webkitGetAsEntry()` returns null when the entry isn't
    // a file or the `DataTransferItem` is not in read/write mode.
