...
import type {WallpaperCalculatedColors} from './color_internals.mojom-webui.js';
import {WallpaperColorsHandler, WallpaperColorsObserverCallbackRouter} from './color_internals.mojom-webui.js';
