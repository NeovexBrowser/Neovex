...
//
// Example usage:
//   neovex://welcome/test_loader.html?module=foo/my_test.js
//
// will load the JS module at chrome/test/data/webui/foo/my_test.js, through the
// neovex://webui-test/foo/my_test.js URL.
//
...
// neovex://webui-test/ data source only exists in a testing context, so using
