...
export function getFileIconUrl(filePath: string): string {
  const url = new URL('neovex://fileicon/');
...
/**
 * Generates a CSS image-set for a neovex:// url.
 ...
 * path.  Resources in neovex://theme have multiple supported scale factors.
 *
 * @param path The path of the image.
 * @return The url, or an image set of URLs.
 */
export function getImage(path: string): string {
  const chromeThemePath = 'neovex://theme';
...
export function getFaviconUrl(
  ...
  // neovex://favicon2 format in components/favicon_base/favicon_url_parser.h.
  const faviconUrl = getBaseFaviconUrl();
